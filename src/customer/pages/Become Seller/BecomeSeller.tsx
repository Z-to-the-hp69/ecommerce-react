...
import SellerLoginFrom from "./SellerLoginFrom";
  ...
  return (
    <div className="grid md:gap-10 grid-cols-3 min-h-screen">
      <section className="lg:col-span-1 md:col-span-2 col-span-3 p-10 shadow-lg rounded-b-md">
        {!isLogin ? <SellerAccountForm /> : <SellerLoginFrom />}
      ...
      <section className="hidden md:col-span-1 lg:col-span-2 md:flex justify-center items-center">
        <div className="lg:w-[70%] px-5 space-y-10">
          <div className="space-y-2 font-bold text-center">
            ...
            <p className="text-lg text-pink-500">Boost your sales today</p>
          </div>
          <img
            src="https://www.nexcess.net/wp-content/uploads/2025/04/15b4d96dc748fa1df20394f76c8c20b272d7919d-1500x1000-1.jpg"
            alt=""
          />
        </div>
      </section>
