...
const PaymentSuccess = () => {
  ...
  useEffect(() => {
    ...
    const paymentLinkedId = getQueryParam("razorpay_payment_link_id"); // ✅ fixed wrong key

    dispatch(
      paymentSuccess({
        jwt: localStorage.getItem("jwt") || "",
        paymentId: paymentId || "",
        paymentLinkedId: paymentLinkedId || "",
      })
    );
  ...
  return (
    <div className="min-h-[90vh]  flex justify-center  items-center">
      <div
        className="bg-primary-color text-white p-8 w-[90%] lg:w-[25%] border rounded-md h-[40vh] flex flex-col gap-7
